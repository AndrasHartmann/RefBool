...
!ls ~/Work/LCSB_EPI_CBG/Data/HighLowEffi/*/*Expression.txt > x.tmp
...
while true
    ...
    % booleanizing everything
     ...
     output = table(HGNC_symbol, expression, bool_value_all, bool_value_all_low, bool_value);
